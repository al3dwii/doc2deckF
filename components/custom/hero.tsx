...
export const Hero = () => {
  ...
  > */}
    {/* You can render text or a button—either way it’s one link */}
    {/* <Button text="لوحة التحكم" className="w-full" /> */}
  {/* </LocaleLink> */}
  
        {/* <LocaleLink
          href="/dashboard"
          className={cn(
            "z-20 w-full max-w-[350px] flex justify-center rounded-xl font-bold",
          )}
          prefetch={false}
        >
          <Button text="لوحة التحكم" className="w-full" />
      ...
      <SignedOut>
        {/* <LocaleLink
          ...
          prefetch={false}
        > */}
          {/* <Button text="التسجيل" className="w-full" /> */}
        {/* </LocaleLink> */}
      </SignedOut>
